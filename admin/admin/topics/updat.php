                        ...
                        <div class="container rounded bg-white mt-5">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="p-3 py-5" method="POST">
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-md-6"><input type="text" class="form-control" name="firstname1" placeholder="first name" value="<?php echo $firstname ?>"></div>
                                            <div class="col-md-6"><input type="text" class="form-control" name="lastname1" placeholder="last name" value="<?php echo $lastname ?>"></div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-md-6"><input type="text" class="form-control" name="email1" placeholder="Email" value="<?php echo $email ?>"></div>
                                            <div class="col-md-6"><input type="text" class="form-control" name="phone1" placeholder="Phone number" value="<?php echo $phone ?>"></div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-md-6"><input type="text" class="form-control" name="adres1" placeholder="address" value="<?php echo $adres ?>"></div>
                                        ...
                                        <div class="mt-5 text-right"><button class="btn btn-primary profile-button" type="button" name = "updat">Save Profile</button></div>
                                    </div>
